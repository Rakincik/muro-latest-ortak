...
for rec in all_recs:
    ...
    if best_mc and best_score >= 26:
        matched_courses.add(best_mc)
        total_records += 1

print(f"Total matched: {len(matched_courses)} / {len(muro_courses)}")
print(f"Total physical records mapped: {total_records}")

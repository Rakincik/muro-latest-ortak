...
export const groupsApi = {
    ...
    update: async (token: string, tenantId: string, id: string, data: { name?: string; description?: string; parentGroupId?: string | null; color?: string; educationType?: string; expirationDate?: string }) => {
